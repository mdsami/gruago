...
class _ProfileViewState extends State<ProfileView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: Text(S.of(context).driver_register_title),
        ),
        body: Query(
              ...
              return Mutation(
                options: MutationOptions(
                    ...
                    update: (GraphQLDataProxy cache, QueryResult? result) {
                      final driver =
                          SetDocumentsOnDriver$Mutation.fromJson(result!.data!);
                      cache.writeQuery(
                          Operation(document: ME_QUERY_DOCUMENT).asRequest(),
                          data: {
