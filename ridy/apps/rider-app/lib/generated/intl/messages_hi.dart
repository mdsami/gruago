...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(time) => "${time} के लिए बुक करें";

  static String m1(count) => "और ${count} अन्य मुद्राएं";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "app_name": MessageLookupByLibrary.simpleMessage("रिड्यू"),
        "copyright_notice": MessageLookupByLibrary.simpleMessage(
            "कॉपीराइट © ryy.io, ठीक है सुरक्षित।"),
        "coupon_heading":
